    ...
    return `
      ...
      <ul class="summary-items">
          <li>
            ...
            <div class="summary-body usersummary">${summary.users[0].numUsers}</div>
          </li>
          <li>
            <div class="summary-title color2">
              <span><i class="fa fa-shopping-basket"></i> Orders</span>
            </div>
            <div class="summary-body ordersummary">${summary.orders[0].numOrders}</div>
          </li>
          <li>
            <div class="summary-title color3">
              <span><i class="fa fa-money"></i> Sales</span>
            </div>
            <div class="summary-body salesummary">₹${summary.orders[0].totalSales}</div>
          </li>
        </ul>
         <div class="charts">
          <div>
