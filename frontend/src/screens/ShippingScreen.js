...
const ShippingScreen = {
    ...
    <div class="container login-cont" style="width:56rem;height:38rem">
      <div class="row my-5">
        <div class="account-wall">
            <form action="" class="form-signin" id="shipping-form">
            <label for="address"  style="margin: 0rem 4rem;" >Address</label>
             <input type="text" class="form-control" id="address" required name="address" value="${address}"style="margin: 1rem 4rem;">
             ...
             <input type="text" class="form-control" id="country" required name="name" value="${country} "style="margin: 1rem 4rem;">
                <button type="submit" class="primary" id="submitids" style="margin:1.5rem 4rem;">Continue</button>
            </form>
        </div>
    </div>
</div>    
